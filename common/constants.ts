...
export const RETURNS_SCHEMA = {
    ...
    'v-cache': false,
    'v-default-fields': ['id', 'createdIn', 'userId', 'orderId', 'name', 'email', 'phoneNumber', 'country', 'locality', 'address', 'totalPrice', 'paymentMethod', 'extraComment', 'giftCardCode', 'giftCardId', 'refundedAmount', 'cardHolder', 'iban', 'status', 'dateSubmitted', 'type'],
    'v-indexed': ['id', 'createdIn', 'userId', 'orderId', 'name', 'email', 'phoneNumber', 'country', 'locality', 'address', 'totalPrice', 'paymentMethod', 'extraComment', 'giftCardCode', 'giftCardId', 'refundedAmount', 'cardHolder', 'iban', 'status', 'dateSubmitted', 'type'],
}
