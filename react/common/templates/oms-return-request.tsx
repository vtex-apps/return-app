export const omsReturnRequest = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\"\n" +
    ...
    "                            Formular nou de retur <br/>{{data.DocumentId}}\n" +
    "                            {{else}}\n" +
    "                            Formular de retur <br/>{{data.DocumentId}}\n" +
    "                            {{/compare}}\n" +
    "                            {{/if}}\n" +
    "                        </h1>\n" +
    "                    </td>\n" +
    ...
    "                                <td>\n" +
    "                                    <h3 style=\"margin: 0; font-size: 20px; line-height: 36px; text-transform: uppercase; letter-spacing: 1.2pt; font-weight: 300; box-sizing: border-box; margin-top: 0 !important;\">\n" +
    "                                        Adresa de ridicare</h3>\n" +
    "                                    <div>\n" +
    "                                        Tara: {{data.country}}<br>\n" +
    "                                        Localitate: {{data.locality}}<br>\n" +
    "                                        Abordare: {{data.address}}\n" +
    "                                    </div>\n" +
    "                                </td>\n" +
    "                            </tr>\n" +
    "                        </table>\n" +
    ...
    "                        align=\"left\">\n" +
    "                        <h3 style=\"margin: 0; font-size: 20px; line-height: 36px; text-transform: uppercase; letter-spacing: 1.2pt; font-weight: 300; box-sizing: border-box; margin-top: 0 !important;\">\n" +
    "                            Metoda de plată a rambursării</h3>\n" +
    "                        Metoda:\n" +
    "                        {{#eq data.paymentMethod 'card'}}\n" +
    "                        Card de credit sau de debit utilizat la achiziționarea comenzii\n" +
    "                        {{/eq}}\n" +
    ...
    "                            {{/eq}}\n" +
    "                            {{#eq data.paymentMethod 'card'}}\n" +
    "                            <b> prin card bancar in valoare de {{formatCurrency data.refundedAmount}} RON</b><br/><br/>\n" +
    "                            {{/eq}}\n" +
    "                            {{#eq data.paymentMethod 'bank'}}\n" +
    "                            <b> prin transfer bancar in valoare de {{formatCurrency data.refundedAmount}} RON</b><br/>\n" +
    "                            <b>IBAN: {{data.iban}}</b>\n" +
    "                            {{/eq}}\n" +
    "                        </div>\n" +
    "                        <div>\n" +
