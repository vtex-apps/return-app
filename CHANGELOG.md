...
- Admin **Create Return** reason dropdown now loads custom return reasons from app settings (with locale, max-days, and optional “Other”), matching storefront behavior and `createReturnRequest` validation.
